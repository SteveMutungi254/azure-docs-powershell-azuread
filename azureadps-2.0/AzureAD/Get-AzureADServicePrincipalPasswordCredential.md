...
See the [migration guide for Get-AzureADServicePrincipalPasswordCredential](./migrate/Get-AzureADServicePrincipalPasswordCredential.md) to the Microsoft Graph PowerShell.
