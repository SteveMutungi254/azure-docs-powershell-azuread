...
See the [migration guide for Get-AzureADServicePrincipalOwnedObject](./migrate/Get-AzureADServicePrincipalOwnedObject.md) to the Microsoft Graph PowerShell.
