...
See the [migration guide for New-AzureADServicePrincipalPasswordCredential](./migrate/New-AzureADServicePrincipalPasswordCredential.md) to the Microsoft Graph PowerShell.
