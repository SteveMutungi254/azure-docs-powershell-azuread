...
See the [migration guide for Remove-AzureADServicePrincipalPasswordCredential](./migrate/Remove-AzureADServicePrincipalPasswordCredential.md) to the Microsoft Graph PowerShell.
