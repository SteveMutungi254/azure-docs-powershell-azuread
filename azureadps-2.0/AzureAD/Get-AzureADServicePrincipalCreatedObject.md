...
See the [migration guide for Get-AzureADServicePrincipalCreatedObject](./migrate/Get-AzureADServicePrincipalCreatedObject.md) to the Microsoft Graph PowerShell.
