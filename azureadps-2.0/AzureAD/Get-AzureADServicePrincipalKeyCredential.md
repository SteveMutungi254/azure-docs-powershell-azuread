...
See the [migration guide for Get-AzureADServicePrincipalKeyCredential](./migrate/Get-AzureADServicePrincipalKeyCredential.md) to the Microsoft Graph PowerShell.
